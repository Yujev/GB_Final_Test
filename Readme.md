...
* Решение задачи здесь: Zadacha/Program.cs

* Блок-схема алгоритма в файле Algoritm.png

* Сам репозиторий доступен по ссылке: https://github.com/Yujev/GB_Final_Test.git 
